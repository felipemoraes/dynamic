...
public class BM25 extends Similarity {
  ...
  public final SimWeight computeWeight(CollectionStatistics collectionStats, TermStatistics... termStats) {
    ...
    return new OkapiBM25Stats(collectionStats.field(), k1, b, idf, avgdl);
  }

  @Override
  public final SimScorer simScorer(SimWeight stats, LeafReaderContext context) throws IOException {
    OkapiBM25Stats bm25stats = (OkapiBM25Stats) stats;
    return new BM25DocScorer(bm25stats, context.reader().getNormValues(bm25stats.field));
  }
  
  private class BM25DocScorer extends SimScorer {
    private final OkapiBM25Stats stats;
    ...
    BM25DocScorer(OkapiBM25Stats stats, NumericDocValues norms) throws IOException {
      this.stats = stats;
  ...
  private static class OkapiBM25Stats extends SimWeight {
    /** BM25's idf */
    ...
    OkapiBM25Stats(String field, float k1, float b, Explanation idf, float avgdl) {
      this.field = field;
      this.idf = idf;
      this.avgdl = avgdl;
  ...
  private Explanation explainTFNorm(int doc, Explanation freq, OkapiBM25Stats stats, NumericDocValues norms) {
  ...
  private Explanation explainScore(int doc, Explanation freq, OkapiBM25Stats stats, NumericDocValues norms) {
