...
public class HierarchicalLDAInferencer {
	...
	public StringBuffer getSampledDistribution(Instance instance, int numIterations,
	 ...
	 public void printNode(NCRPNode node, int indent) {
			...
			out.append(node.getTopWords(numWordsToDisplay,false));
	  ...
	  public void printNodeTree(NCRPNode node, StringBuffer out, String topicId) {
		  
		  for (NCRPNode child: node.children) {
			for (NCRPNode grandChild: child.children) {
				out.append(topicId);
				out.append(";");
				out.append(node.getTopWords(10, false));
				out.append(";");
				out.append(child.getTopWords(10, false));
				out.append(";");
				out.append(grandChild.getTopWords(10, false));
				out.append("\n");
			}
