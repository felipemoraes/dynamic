...
public class xQuADssSession implements Session {
	...
	public void run() {
		for (float[] params : getParameters()) {
			String runName = "xQuADss_" + (int) params[0] + "_" + String.format("%.1f" ,params[1]);
			run(runName,params);
		}
