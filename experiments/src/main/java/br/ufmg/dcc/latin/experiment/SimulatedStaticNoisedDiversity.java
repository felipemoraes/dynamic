...
public class SimulatedStaticNoisedDiversity {
	...
	public static void main(String[] args) throws IOException {
	    ...
	    FileWriter fw = new FileWriter( "SimulatedStaticNoisedDiversity4" + args[0] + ".txt");
	    ...
	    while ((line = br.readLine()) != null) {
		    ...
		    for (int k = 0; k < 100; k++) {
			   ...
			   for (int i = 0; i < 10; i++) {
	    			...
	    			Evaluator.writeToFile("Static_" + args[0] + "_xQuAD_" + k , topicId, resultSet, i);
	    			...
	    			Evaluator.writeToFile("Static_" +  args[0] +"_PM2_" + k , topicId, resultSet, i);
	    			...
	    			Evaluator.writeToFile("Static_" +  args[0] + "_Base_" + k , topicId, resultSet, i);
